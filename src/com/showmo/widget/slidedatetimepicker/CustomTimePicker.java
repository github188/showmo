package com.showmo.widget.slidedatetimepicker;
...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.drawable.orange_line));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.drawable.orange_line));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.orange_line));
        }
