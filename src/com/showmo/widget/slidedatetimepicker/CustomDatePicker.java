...
public class CustomDatePicker extends DatePicker
{
    ...
    public CustomDatePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.drawable.orange_line));
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.drawable.orange_line));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.drawable.orange_line));
        }
