...
class MyRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        synchronized(this) {
            if (updateSurface) {
                ...
                if(count>0){
                	long time=SystemClock.elapsedRealtime()-mLastTime;
                	if(time>=10*1000){
                		double fps=(count-1)/(time/1000);
                		//Log.e("***********","*****"+fps);
                	}
                }
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height) {
    	...
    	Log.i("onSurfaceChanged", "onSurfaceChanged");
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
    	...
    	Log.i("onSurfaceCreated", "onSurfaceCreated");
    ...
    synchronized public void onFrameAvailable(SurfaceTexture surface) {
         ...
         */
        updateSurface = true;
       // Log.e(TAG, "onFrameAvailable " + surface.getTimestamp());
    }
    ...
    private SurfaceTexture mSurface=new SurfaceTexture(mTextureID);
	public Surface surface = new Surface(mSurface);
